...
<div class="p-4 sm:ml-64 min-h-screen flex flex-col items-center justify-center">
    ...
    <form action="../../modules/jadwal/jadwalController.php" method="POST"
        ...
        <div class="mb-5">
            ...
            <input type="number" id="idBooking" name="idBooking"
                value="<?= htmlspecialchars($jadwal['idBooking']) ?>"
                class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
        </div>
        ...
        <div class="mb-5">
            ...
            <input type="time" id="jamMulai" name="jamMulai"
                value="<?= htmlspecialchars($jadwal['jamMulai']) ?>"
                class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
        </div>
        ...
        <div class="mb-5">
            ...
            <input type="time" id="jamSelesai" name="jamSelesai"
                value="<?= htmlspecialchars($jadwal['jamSelesai']) ?>"
                class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
        </div>
        ...
        <div class="mb-5">
            ...
            <input type="text" id="catatan" name="catatan" maxlength="100"
                value="<?= htmlspecialchars($jadwal['catatan']) ?>"
                class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
        </div>

        <button type="submit" name="editJadwal"
