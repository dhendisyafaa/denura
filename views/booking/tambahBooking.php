...
<div class="p-4 sm:ml-64 min-h-screen flex flex-col items-center justify-center">
  ...
  <form action="../../modules/booking/bookingController.php" method="POST"
    ...
    <div class="mb-5">
      ...
      <input type="text" id="lokasi" name="lokasi" maxlength="100" class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
    </div>
    ...
    <button type="submit" name="tambahBooking" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none 
