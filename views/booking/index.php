                        ...
                        <tr class="odd:bg-gray-900 even:bg-gray-800 border-b border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <div class="inline-flex" role="group">
                                    <a href="editBooking.php?id=<?= $booking['idBooking'] ?>" class="px-4 py-2 text-sm font-medium text-orange-500 bg-white border border-gray-200 rounded-s-lg hover:bg-gray-100">
                                        Edit
                                    </a>
