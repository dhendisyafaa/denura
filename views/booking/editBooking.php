...
<div class="p-4 sm:ml-64 min-h-screen flex flex-col items-center justify-center">
  ...
  <form action="../../modules/booking/bookingController.php" method="POST"
    ...
    <div class="mb-5">
      ...
      <input type="number" id="idJasa" name="idJasa" value="<?= htmlspecialchars($booking['idJasa']) ?>" class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
    </div>

    <div class="mb-5">
      <label for="lokasi" class="block mb-2 text-sm font-medium text-gray-900">Lokasi</label>
      <input type="text" id="lokasi" name="lokasi" value="<?= htmlspecialchars($booking['lokasi']) ?>" maxlength="100"
    ...
    <div class="mb-5">
      ...
      <select name="paketPilihan" id="paketPilihan" required class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
    ...
    <div class="mb-5">
      ...
      <select name="status" id="status" required class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
    ...
    <button type="submit" name="editBooking" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none 
