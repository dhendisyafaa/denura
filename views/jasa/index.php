<?php
include '../../controllers/jasaController.php';
$jasaList = getAllJasa();
?>
                        ...
                        <tr class="odd:bg-gray-900 even:bg-gray-800 border-b border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <div class="inline-flex rounded-md shadow-xs" role="group">
                                    <a href="editJasa.php?id=<?= $jasa['idJasa'] ?>" type="button" class="px-4 py-2 text-sm font-medium text-orange-500 bg-white border border-gray-200 rounded-s-lg hover:bg-gray-100 hover:text-gray-700 focus:z-10 focus:ring-2 focus:ring-gray-700 focus:text-gray-700">
                                        Edit
                                    </a>
                                    <form method="POST" action="../../controllers/jasaController.php" onsubmit="return confirm('Yakin ingin menghapus jasa ini?');">
