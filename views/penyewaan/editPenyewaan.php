...
<div class="p-4 sm:ml-64 min-h-screen flex flex-col items-center justify-center">
    ...
    <form action="../../controllers/barangController.php" method="POST" class="w-md mx-auto my-5 p-5 border border-gray-200 rounded-lg shadow-sm">
        ...
        <div class="mb-5">
            ...
            <input placeholder="Rp" type="number" id="hargaSewa" name="hargaSewa" value="<?= htmlspecialchars($penyewaan['hargaSewa']) ?>" class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required />
        </div>
        <button type="submit" name="editSewa" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Simpan Barang</button>
    </form>
</div>
